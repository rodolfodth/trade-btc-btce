        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="auto-trade.php">Auto Trade</a></li>
...
# Configurações de API, coloque suas chaves aqui
...
if(isset($_GET["c"]))
{
	if(@ChecarOrdem($_GET["c"])) 
	{
		...
		die("<button type='button' class='btn btn-info'>Venda</button> </br></br>Aguardando fechamento da ordem de venda ... <script>setTimeout(function(){location.href='auto-trade.php?c=".$oid."';},5000);</script>");
	}
	die("Ordem fechada com sucesso, criando ordem pra compra ... <script>setTimeout(function(){location.href='auto-trade.php';},5000);</script>");
}
...
echo "<p><button type='button' class='btn btn-warning'>Estatísticas</button><br/><br/> Estimativa de Lucro: <b>$".$lucro."</b><br/>Estimativa de Prejuízo: <b>$".$prejuizo."</b><br/>Valor de Compra: <b>

{$min}$</b><br/>Valor de Venda: <b>{$max}$</b><br/><br/></p>";
...
# Verificar se um ID foi gerado
if($oid == 0) RefazerTrade("<br/><button type='button' class='btn btn-danger'>Erro</button> Ocorreu um erro ao criar as ordens!") ;



# Finalizar, checando periodicamente se a segunda ordem foi fechada tambem
die("<script>setTimeout(function(){location.href='auto-trade.php?c=".$oid."';},5000);</script>");
...
function VenderBitcoins($valorbtc, $quantosbtc) {
	...
	try {
		echo "<p><button type='button' class='btn btn-success'>Venda</button></br><br/> Ordem Criada: <b>$quantosbtc btc</b>. Cotação: <b>$valorbtc</b><br/></p>";
...
function ComprarBitcoins($valorbtc, $quantosbtc) {
	...
	try {
		echo "<p><button type='button' class='btn btn-success'>Compra</button></br><br/> Ordem Criada: $quantosbtc btc. Cotação: $valorbtc<br/><p/>";	
